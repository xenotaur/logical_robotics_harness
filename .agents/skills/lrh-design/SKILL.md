---
name: lrh-design
description: "Generate a structured design for a feature, improvement, or system.\
  \ Given an idea or topic as the argument, reviews the idea, surveys best practices,\
  \ produces a high-level design, identifies low-level choices, evaluates pros and\
  \ cons, and recommends an approach\u2014stopping to clarify or raise blockers when\
