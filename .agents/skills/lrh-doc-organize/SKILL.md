...
description: "Implement one scoped phase of Diataxis-informed documentation reorganization\
  \ as a reviewable PR. Reads the \"Proposed first PR scope\" section from a docs-audit\
  \ artifact produced by /lrh-doc-audit (or runs a small discovery pass if no audit\
