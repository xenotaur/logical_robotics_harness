---
name: lrh-work-item
description: 'Create a new LRH work item in project/work_items/proposed/. Use when
  the user wants to capture a deliverable, operation, investigation, or evaluation
  as a formal work item. Interviews the user, researches related workstreams and focus,
  proposes complete frontmatter and body sections, and writes the file after explicit
