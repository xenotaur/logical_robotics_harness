...
when_to_use: "Use when the user wants a landing recommendation for a specific open\
  \ PR before deciding whether to merge, close as obsolete/superseded, or hold it\
  \ pending a fix. This is a candidate input to WS-INVOCATION-AND-GATE-RESET Stage\
  \ 5b (\"Session and PR triage: related \xD7 go/no-go across open PRs and live sessions\"\
  ) \u2014 until that workstream lands, this skill covers the single-PR investigation\
  \ case standalone.\n"
context: fork
---
