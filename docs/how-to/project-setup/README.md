...
- [Setting up a conda environment](conda-environment.md) — bootstrap a personal conda (or venv) development environment for this repository, and why there's no committed `environment.yml` to build from.
