...
| `lrh conversation current-claude-session-id` (`claude_session.py:131`) | env `CLAUDE_CODE_SESSION_ID`, `CLAUDE_CODE_HOST_SESSION_ID`; globs the transcript path | stdout | Metadata only. Already yields the host pointer. |
