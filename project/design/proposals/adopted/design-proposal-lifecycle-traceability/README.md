# Design Proposal Lifecycle and Implementation Traceability

Status: `adopted` / `partial`

Reading order:

1. [`00_proposal.md`](00_proposal.md) — proposes first-class design
   proposal decision lifecycle metadata, separate implementation
...
framework remain outside the completed work.
