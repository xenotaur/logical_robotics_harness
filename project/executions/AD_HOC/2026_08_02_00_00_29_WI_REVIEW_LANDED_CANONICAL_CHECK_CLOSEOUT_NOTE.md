...
- This PR is a second, independent real-world data point (alongside PR
  #442) for `WI-REVIEW-ROUND-ESCALATION-GATE` (still `proposed`,
  unimplemented) — 4 rounds of unattended-shaped review escalation, this
  time resolved via explicit human confirmation at each round rather than
  a numeric ceiling.
