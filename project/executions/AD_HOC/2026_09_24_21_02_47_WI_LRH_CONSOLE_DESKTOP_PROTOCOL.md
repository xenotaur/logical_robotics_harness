...
Use `/lrh-work-item` to capture the first proposed L0 deliverable for the versioned desktop/server lifecycle contract in the user's requested single review PR.
This records creation of a planning artifact, not execution of its future scope.

# Result

Created `project/work_items/proposed/WI-LRH-CONSOLE-DESKTOP-PROTOCOL.md` as part of
