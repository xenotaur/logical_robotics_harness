...
This completed focus established **planning-tree semantics and workstreams** as core LRH
...
Archived when the active focus moved to `FOCUS-EXECUTION-FRAMEWORK-PLANNING` so historical
workstream-control-plane work items can continue to reference this focus without being included in
execution-framework prompt/context generation.
