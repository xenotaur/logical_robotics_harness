...
acceptance:
  - The Stage 3 DEC's compensating control is present, named, and checked before activation proceeds
...
replaces the removed chain-runner flags.
...
- Verify the Stage 3 compensating control exists and is checkable.
...
1. Read the Stage 3 DEC and verify the named compensating control is present.
