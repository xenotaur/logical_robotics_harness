...
def get_template_root_from_script_path(script_path: pathlib.Path) -> pathlib.Path:
    """Return request-template directory relative to scripts/aiprog/request.py."""
    return script_path.resolve().parent / "templates" / "request"
